    ...
    attach: function (context, settings) {
      $(context).find('.tp-carousel-team-members').once('mtowlCarouselTeamMembersInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.njalaapp.owlCarouselTeamMembersInit.owlTeamMembersAutoPlay,
          autoplayTimeout: drupalSettings.njalaapp.owlCarouselTeamMembersInit.owlTeamMembersEffectTime,
          nav: true,
          dots: false,
          loop: true,
