    ...
    attach: function (context, settings) {
      $(context).find('.tp-carousel-products').once('mtowlCarouselProductsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.njalaapp.owlCarouselProductsInit.owlProductsAutoPlay,
          autoplayTimeout: drupalSettings.njalaapp.owlCarouselProductsInit.owlProductsEffectTime,
          nav: true,
          dots: false,
          loop: true,
